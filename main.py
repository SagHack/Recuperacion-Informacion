...
class RelevanceData:
    ...
    def total_docs_real(self, iNeed):
        doc = self.df_qrels[self.df_qrels["information_need"] == iNeed]
    ...
    def average_precision(self, iNeed):
        ...
        for i in range(n_total):
            if self.is_relevant(iNeed,self.df_results_50["document_id"][i]):
                ...
                tot_no_rel += 1
        print("precision_acumulada: ", precision_acumulada)
        print("tot_rel: ", tot_rel)
        if(tot_rel == 0):
            return 0.0
...
def main():
    ...
    for iNeed in all_information_needs:
        ...
        print("LOS FICHEROS QUE UTILIZO para",iNeed)
        print(relevance_data.df_results_50)
