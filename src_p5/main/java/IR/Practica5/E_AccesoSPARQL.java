...
public class E_AccesoSPARQL {
	...
	public static void main(String args[]) {
		...
		// Cosulta de literales que contengan el texto "Berners-Lee"
		//String queryString = "Select ?x ?y ?z WHERE  {?x ?y ?z. FILTER(contains(str(?z), 'Berners-Lee')) }" ;

		// Consulta que devuelve el título de todos los documentos creados por Tim Berners-Lee
		String queryString = "SELECT ?document ?title\n" +
				"WHERE {\n" +
				"  ?document <http://miuri/inverseSameAs> <http://www.w3.org/People/Berners-Lee/card#i>.\n" +
